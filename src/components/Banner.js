          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={ isVisible ? "animate__animated animate__fadeIn" : ""}>
                <h1 >{`Hi! Welcome to`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Intersect!" ]'><span className="wrap">{text}</span></span></h1>
            ...
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__zoomIn" : ""}>
                  <img src="./images/about-icon (1).png" alt="Header Img"/>
                </div>}
            </TrackVisibility>
          </Col>
        </Row>
